...
![2-Tier vs 3-Tier Clos Architecture](./diagrams/tier-comparison.svg)
...
![Oversubscription Ratio — 48-port switch with 32 downlinks and 16 uplinks](./diagrams/oversubscription-ratio.svg)
...
![Cloud vs AI Fabric — traffic patterns and oversubscription](./diagrams/ai-vs-cloud.svg)
